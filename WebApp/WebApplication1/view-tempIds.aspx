<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view-tempIds.aspx.cs" Inherits="WebApplication1.create_tempIds" %>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="temporaryIds-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="view-tempIds.aspx" class = "active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>View Temporary Ids</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.aspx">Home</a></li>
          <li class="breadcrumb-item">View Temporary Ids</li>
          <li class="breadcrumb-item active">View Temporary Ids</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Temporary IDs</h5>
                <!-- Bordered Table -->
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
                      <th scope="col">Temporary ID</th>
