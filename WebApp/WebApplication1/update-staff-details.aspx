<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update-staff-details.aspx.cs" Inherits="WebApplication1.create_tempIds" %>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="staffIds-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="update-staff-details.aspx" class = "active">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form>
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <select class="form-select" aria-label="Default select example">
                        ...
                        <option value="1">DFCU001</option>
                        <option value="2">DFCU002</option>
                        <option value="3">DFCU003</option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Othername(s)</label>
                  <div class="col-sm-10" >
                    <input type="text" class="form-control" disabled>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">ID Photo</label>
                  <div class="col-sm-10">
